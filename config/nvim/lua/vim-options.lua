...
-- sync the vim clipboard with the system clipboard
vim.schedule(function()
	vim.opt.clipboard = "unnamedplus"
end)

-- clear highlights and searches when hitting escape key
...
-- paste from the clipboard without overwriting the system clipboard
...
-- Copilot change the accept key to <C-j>
